...
def calculate_scenario(identifier_1, value_1, identifier_2, value_2): # There are only 9 possible scenarios in a right-angled triangle with two inputs
    if identifier_1 in ["a", "b"] and identifier_2 in ["b", "c"]: # Check if both identifiers are side lengths (first three scenarios)
        if identifier_1 == "a":
            if identifier_2 == "b":
    ...
    elif identifier_1 in ["a", "b", "c"] and identifier_2 in ["A", "B"]: # Check if the identifiers are one side length and one angle (last six scenarios)
        if identifier_1 == "a":
            if identifier_2 == "A":
